...
public class Images_Adapter extends BaseAdapter {
    ...
    Images_Adapter(Context context, List<Images_Adapter_items> rowItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.images_list_items, null);
        ...
        Images_Adapter_items row_pos = rowItems.get(position);
